...
local captchaGracePeriod = 300
local lastInteractionType = nil

local captchaBaseNames = {
    "226md",
    "22d5n",
    "2356g",
    "23mdg",
...
for i, baseName in ipairs(captchaBaseNames) do
    table.insert(captchaFiles, {
        file = "Interface\\AddOns\\FlightCaptcha\\samples\\" .. baseName .. ".tga",
        answer = baseName
    })
end
    ...
    if not captchaFrame then
        ...
        confirmBtn:SetScript("OnClick", function()
            ...
            if userAnswer and userAnswer:lower() == captchaAnswer:lower() then
                ...
                print("|cffffd200[Captcha]|r Correct! You may continue.")
            else
